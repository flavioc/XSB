...
; double click on this to run with inno, then build-menu, compile.
...
Name: "{group}\XSB-MT"; Filename: "{app}\config\i686-pc-cygwin-mt\bin\xsb.exe"; Parameters: ""; Comment: "Runs XSB (Multi-threaded) within a command shell"; WorkingDir: "{userdocs}"; Components: base; Flags: createonlyiffileexists

Name: "{group}\XSB-VC"; Filename: "{app}\config\x86-pc-windows\bin\xsb.exe"; Parameters: ""; Comment: "Runs XSB (MSVC-compiled) within a command shell"; WorkingDir: "{userdocs}"; Components: base; Flags: createonlyiffileexists
