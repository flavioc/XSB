...
!MESSAGE For example:
!MESSAGE 
!MESSAGE NMAKE /f "Makefile.mak" CFG="debug" DLL="yes"
!MESSAGE 
...
!MESSAGE 
!MESSAGE NMAKE /f "Makefile.mak" CFG="release" && ORACLE="yes"
!MESSAGE 
...
OUTDIR=..\config\x86-pc-windows\saved.o
!ELSE
...
!MESSAGE Usage:
!ERROR NMAKE /f "Makefile.mak" CFG="..." ORACLE=yes SITE_LIBS="oracle libs"
!ENDIF
!ENDIF
