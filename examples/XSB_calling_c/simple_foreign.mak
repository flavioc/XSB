...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib xsb.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\simple_foreign.pdb" /debug /machine:I386 /out:"$(OUTDIR)\simple_foreign.dll" /implib:"$(OUTDIR)\simple_foreign.lib" /pdbtype:sept /libpath:"..\..\config\x86-pc-windows\bin" 
LINK32_OBJS= \
	"$(INTDIR)\simple_foreign.obj"
