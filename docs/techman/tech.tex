...
predicate is indexed, and has clauses defined the instruction is a
{\tt jump}, to the first clause reference of the predicate.
Otherwise, the predicate is not indexed, and has clauses defined for
it the instruction is a {\tt jumptbreg} which jumps and sets a choice
point.
