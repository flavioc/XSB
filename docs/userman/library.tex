...
fd2iostream/2}.  In these stream-oriented communication, messages have
no boundaries, and communication appears to the processes as reading
and writing to a file.  At present, buffered stream-oriented
...
which must be an integer in a given range.
...
XSB contains a simple but useful pretty-printer~\footnote{This library
uses code both from hProlog and Ciao.}.
