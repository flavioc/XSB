...
Given as input a {\tt List} character codes, {\tt scan/2} scans this
list producing a list of atoms constituting the lexical tokens.  Its
...
Given as input a {\tt List} character codes, along with a character
...
{\em scan/3} thus be used to scan tabular information.  Its
parameters are set via {\tt set\_scan\_pars/1}.
...
\item{{\tt letter(Code)}} adds {\tt Code} as a special character.  By
default, ASCII codes for the following characters are regarded as
special characters: 
