...
All predicates in this section must be imported from module {\tt unix}.
...
To tell that a certain port is not needed, it suffices to pass an atom to
\verb|spawn_process/5|. For instance,
%%
\begin{verbatim}
...
\end{verbatim}
%%
In each case, only one of the ports is open. Finally, if both ports are
