...
\ournewitem{current\_input\_fd(-IOport)}{curr\_sym} \index{{\tt current\_input\_fd/}}
   See {\tt current\_output\_fd/1}.
\ournewitem{current\_output\_fd(-IOport)}{curr\_sym} \index{{\tt current\_output\_fd/}}
...
\ournewitem{file\_clone(+SrcIOport,?DestIOport,-RetCode)}{file\_io}\index{{\tt file\__clone/1}}
