...
\ournewitem{file\_flush(+FileDes, -Return)}{machine}\index{{\tt file\_flush/2}}
    Any buffered data gets delivered. If the call is successful, {\tt Return}
    is zero; otherwise {\tt EOF} is returned.

\ournewitem{file\_seek(+FileDes, +Offset, +Place, -Return)}{machine}\index{{\tt file\_seek/4}}
...
\ournewitem{file\_truncate(+FileDes, +Length, -Return)}{machine}\index{{\tt file\_truncate/3}}
