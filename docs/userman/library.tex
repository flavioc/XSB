...
\index{{\tt intern\_string/2}}
    ...
    {\bf Important}: Reading large files using this function can cause XSB
    to run out of memory, because all strings are converted to atoms.
    This problem will go away when atom table garbage collection is
    implemented for XSB.
