...
information interned by one trie will not be visible to other threads.
...
understanding of the trie mechanism in XSB.  They can be used to
implement modules such as the {\tt storae} module described in Volume
1.
%%
\begin{description}
  %%
