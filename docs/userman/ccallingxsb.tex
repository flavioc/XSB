...
the use of this interface are given in the {\tt XSB/examples/c_calling_XSB}
...
First, you must create a relocatable file, named {\tt xsbmodule.o}, that
...
\begin{verbatim}
    % gcc -o ruleproc ruleproc.o $XSB_DIR/emu/xsbmodule.o
\end{verbatim}

There is a simple example of a C program calling \ourprolog\ in the
{\tt XSB/examples/c_calling_XSB} directory, in files {\tt cmain.c}, {\tt
  ctest.P}, cmain2.c {\tt and},  {\tt Makefile}.
