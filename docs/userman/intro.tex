...
Windows-based platforms.  In addition to providing all the
...
\item A variety of indexing techniques for asserted code and both
backtrackable and non-backtrackable updates to asserted code.
%
\item A set of mature packages, to extend XSB to evaluate
F-logic~\cite{KLW95} through the {\em FLORA} package, to manage
ontologogies through the {\em Cold Dead Fish} package, and to support
literate programming through the {\tt xsbdoc} package, among other
features.
%
