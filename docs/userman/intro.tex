...
\ref{mode_declarations} for more details.  \index{notational
  conventions} Error cases for predicates designate the first argument
of a 2 or 3 argument error term, to allow use by error
handlers~\footnote{We are approaching compatibility in the use of
