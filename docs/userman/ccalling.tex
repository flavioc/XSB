...
\ouritem{int xsb\_command\_string(char *)} \index{{\tt xsb\_command\_string}}
...
\ouritem{int xsb\_query\_string(char *)} \index{{\tt xsb\_query\_string}}
...
\ouritem{int xsb\_query\_string\_string(char *,char *,int,char *)}
...
\ouritem{int xsb\_next\_string(char *,int,char *)} \index{{\tt
