...
\begin{description}
%
\isoitem{asserta(+Clause)}{ISO}{asserta/1}
%
...
\isoitem{assert(+Clause)}{assert/1}
%
If the index specification for the predicate is not {\tt trie}, this
predicate adds a dynamic clause, {\tt Clause}, to the database {\em
  after} any other clauses for the same predicate currently in the
...
\isoitem{retract(+Clause)}{ISO}{retract/1}
%
...
\isoitem{dynamic(+PredSpec)}{dynamic/1}\label{dynamic/1}
%
...
\standarditem{load\_dync(+FileName,+Dir)}{load\_dync/2} \label{load_dync/2}
