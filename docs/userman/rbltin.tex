...
\ouritem{storage\_delete\_keypair(+StorageName, +Key, ?Deleted)}\index{{\tt
...
\ouritem{storage\_find\_keypair(+StorageName, +Key, ?Value)}\index{{\tt
...
\ouritem{storage\_delete\_fact\_bt(+StorageName, +Goal)} \index{{\tt
