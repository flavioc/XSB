...
executable directive, if {\tt Predicate} is not previously defined, it
will be initialized to a dynamic predicate without any clauses.  If
{\tt Predicate} is previously defined and dynamic, {\tt dynamic/1} has
no effect.  If {\tt Predicate} is previously defined as static, a
permission error will be thrown.  If {\tt Predicate} is previously
defined as static, a permission error will be thrown.

{\bf Error Cases}
\bi
\item 	{\tt Predicate} has been previously defined to be static
\bi
