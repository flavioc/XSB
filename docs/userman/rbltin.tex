...
page~\pageref{load_dyn/1}).  There is a {\tt dynamic/1} predicate (see
...
\ouritem{cd(+Dir)}\index{{\tt cd/1}}
    Under UNIX and DOS, this predicate changes the interpreter's working 
    directory to {\tt Dir}.  If the directory
