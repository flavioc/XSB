...
\begin{description}
%
\ourmoditem{trie\_create(-TrieId,+OptionList)}{intern}\index{\texttt{trie\_create/2}}
%
...
\ourmoditem{trie\_insert(+TrieIdOrAlias,Term)}{intern}
...
\ourmoditem{trie\_unify(+TrieIdOrAlias,Term)}{intern}
...
\ourmoditem{trie\_delete(+TrieIdOrAlias,Term)}{intern}
...
\ei
%
\ourmoditem{trie\_truncate(+TrieIdOrAlias)}{intern}
...
\ourmoditem{trie\_drop(+TrieIdOrAlias)}{intern}
...
\ourmoditem{trie\_property(?TrieOrAlias,?Property)}{intern}
