...
\ournewitem{trie\_bulk\_insert(+TrieIdOrAlias,+Generator)}{intern}
...
\ournewitem{trie\_bulk\_delete(+TrieIdOrAlias,Term)}{intern}
...
\ournewitem{trie\_bulk\_unify(+TrieIdOrAlias,\#Term,-List)}{intern}
