...
addition, tables private to a thread are abolished automatically and
their space reclaimed when the thread exits (by normal termination or
via an exception).  Shared tables can be abolished at any time, but
their space will not be reclaimed until there is a single active
thread.
