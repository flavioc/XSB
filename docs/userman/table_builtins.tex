...
\standarditem{table\_state(+CallTerm,?PredType,?CallType,?AnsSetStatus)}{table\_state/1}
...
\ournewitem{abolish\_table\_pred(+CallTerm,+Options)}{Tabling}
\index{\texttt{abolish\_table\_pred/2}}
%
...
\ournewitem{abolish\_table\_call(+CallTerm,+Options)}{Tabling}
\index{\texttt{abolish\_table\_call/2}}
%
