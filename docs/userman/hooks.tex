...
\begin{description}
\ourmoditem{add\_xsb\_hook(+HookSpec)}{xsb\_hook} \index{\texttt{add\_xsb\_hook/1}} 
...
\ourmoditem{remove\_xsb\_hook(+HookSpec)}{xsb\_hook} \index{\texttt{remove\_xsb\_hook/1}}
...
\begin{description}
\ourmoditem{xsb\_exit\_hook(\_)}{xsb\_hook} \index{\texttt{xsb\_exit\_hook/1}}
...
\ourmoditem{xsb\_assert\_hook(\_)}{xsb\_hook} \index{\texttt{xsb\_assert\_hook/1}}
...
\ourmoditem{xsb\_retract\_hook(\_)}{xsb\_hook} \index{\texttt{xsb\_retract\_hook/1}}
