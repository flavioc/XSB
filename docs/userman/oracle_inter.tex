...
\item Rebuild orastuff.c from orastuff.pc by running
  \\
  {\tt make -f proc.mk orastuff}
  \\
  If this does not work, you might need to use the version of proc.mk
  included with your copy of Oracle In that case, see the changes we made
  to our proc.mk and reflect them to the Oracle's version of proc.mk.
