...
\ei
\item 	Closing the stream produces an error.
\bi
\item 	{\tt permission\_error(close,stream,Stream\_or\_alias)}
\ei
\ei

\ournewitem{close(+Stream\_or\_alias.+Options)}{ISO}\index{\texttt{close/2}}
...
\begin{description}
\ournewitem{fmt\_read(+Fmt,-Term,-Ret)}{file\_io}\index{\texttt{fmt\_read/3}}
\vspace{-7mm}
\ournewitem{fmt\_read(+IOport,+Fmt,-Term,-Ret)}{file\_io}\index{\texttt{fmt\_read/4}}
...
\ournewitem{fmt\_write(+Fmt,+Term)}{file\_io}\index{\texttt{fmt\_write/2}}
\vspace{-7mm}
\ournewitem{fmt\_write(+IOport,+Fmt,+Term)}{file\_io}\index{\texttt{fmt\_write/3}}
...
\index{\texttt{fmt\_write\_string/2}}
