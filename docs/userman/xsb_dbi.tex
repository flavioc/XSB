...
\end{verbatim}
%%
to indicate where MySQL is installed: Search for the variables
{\tt MySQLLib} and {\tt MySQLIncludeDir} at the top of the file and replace  
the text of the form {\tt <...>}  with the appropriate directories.
...
\end{verbatim}
%%
Other than that, no special configuration steps are required --- the
appropriate files will be compiled automatically the first time you use
the various drivers.
