...
\begin{description}
\ournewitem{use\_incremental\_tabling(+PredSpecs)}{standard}\index{\texttt{use\_incremental\_tabling/1}}
...
\ournewitem{use\_incremental\_dynamic(+PredSpecs)}{standard}\index{\texttt{use\_incremental\_dynamic/1}}
...
\ournewitem{use\_opaque\_tabling(+PredSpecs)}{standard}\index{\texttt{use\_opaque\_tabling/1}}
...
\ournewitem{incr\_retractall(+Clause)}{increval}\index{\texttt{incr\_retractall/1}}
...
\ournewitem{incr\_retractall\_inval(+Clause)}{increval}\index{\texttt{incr\_retractall\_inval/1}}
