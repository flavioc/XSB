...
\begin{description}
\ourstandarditem{use\_incremental\_tabling(+PredSpecs)}{use\_incremental\_tabling/1}{Tabling}
...
\ourstandarditem{use\_incremental\_dynamic(+PredSpecs)}{use\_incremental\_dynamic/1}{Tabling}
...
\ourstandarditem{use\_opaque\_tabling(+PredSpecs)}{use\_opaque\_tabling/1}{Tabling}
...
\begin{description}
\ourmoditem{incr\_assert(+Clause)}{incr\_assert/1}{increval}
