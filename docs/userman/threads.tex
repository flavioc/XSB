...
\subsection{Predicates for Thread Synchronization} \label{sec:mutex}
...
\begin{description}
\ournewitem{with\_mutex(+Mutex,?Goal)}{thread}
...
\ournewitem{mutex\_create(?Mutex)}{thread}
...
\ournewitem{mutex\_destroy(+Mutex)}{thread}
...
\ournewitem{mutex\_lock(+Mutex)}{thread}
...
\ournewitem{mutex\_trylock(+Mutex)}{thread}
...
\ournewitem{mutex\_unlock(+Mutex)}{thread}
...
\ournewitem{mutex\_unlock\_all}{thread}
...
\ournewitem{mutex\_property(?Mutex,?Property)}{thread}
