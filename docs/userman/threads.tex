...
\ournewitem{thread\_create(+Goal)}{thread}
...
\ournewitem{thread\_cancel(+Thread\_or\_Alias)}{thread}
...
\ournewitem{thread\_signal(Thread\_or\_Alias,Goal)}{thread}
...
\ournewitem{thread\_property(?ThreadOrAlias,?Property)}{thread}
...
\ournewitem{thread\_sleep(+Seconds)}{thread}
...
%
\begin{description}
\ournewitem{message\_queue\_create(-Queue,+Options)}{mutex\_xsb}
...
\ournewitem{message\_queue\_detroy(+Queue\_or\_Alias,\#Message)}{mutex\_xsb}
...
\ournewitem{thread\_send\_message(+Queue\_or\_Alias,\#Message)}{mutex\_xsb}
...
\ournewitem{thread\_get\_message(+Queue\_or\_Alias,?Message)}{mutex\_xsb}
...
\ei
%
\ournewitem{thread\_get\_message(?Message)}{mutex\_xsb}
\index{\texttt{thread\_get\_message/1}} 
%
Acts as {\tt thread\_get\_message/2}, but on a thread's private queue.

\ournewitem{thread\_peek\_message(+Queue\_or\_Alias,?Message)}{mutex\_xsb}
...
\ei
%
\ournewitem{thread\_peek\_message(?Message)}{mutex\_xsb}
...
\begin{description}
\ournewitem{with\_mutex(+Mutex,?Goal)}{mutex\_xsb}
...
\ournewitem{mutex\_create(?Mutex)}{mutex\_xsb}
...
\ournewitem{mutex\_destroy(+Mutex)}{mutex\_xsb}
...
\ournewitem{mutex\_lock(+Mutex)}{mutex\_xsb}
...
\ournewitem{mutex\_trylock(+Mutex)}{mutex\_xsb}
...
\ournewitem{mutex\_unlock(+Mutex)}{mutex\_xsb}
...
\ournewitem{mutex\_unlock\_all}{mutex\_xsb}
...
\ournewitem{mutex\_property(?Mutex,?Property)}{mutex\_xsb}
