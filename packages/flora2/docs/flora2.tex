...
other features. Chang Zhao added a number of important enhancements, such
as run-time undefinedness checks and the checker for dependency among
tabled predicates and updates.
