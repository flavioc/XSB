...
\section{Authors}
\FLORA was designed and implemented by Guizhen Yang, but its origins trace
back to the \FLIP compiler developed by Bertram Lud\"aescher. In
particular, certain ideas, such as the use of trailer files, originates
with \FLIP.
...
and updates. Bin Tang added support for numbered anonymous oids.
