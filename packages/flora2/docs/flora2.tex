...
that enabling these checks can slow runtime by a factor of 2 or 3, so we
recommend this to be done during debugging only.

To enable runtime checks for undefined invocations, put the compiler
directive
%%
\begin{quote}
 {\tt
...
\end{quote}
%%
at the top of the file where these checks are to be enabled. This feature
