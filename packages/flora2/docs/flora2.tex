...
``$\sim$'', introduced in Section~\ref{sec-meta-reification}.
...
\index{meta-unification!$\sim$ operator}
...
\index{reification}
\index{reification!$\sim$ operator}
\index{$\sim$!reification operator}
%%
...
Reification is done using the unary operator ``$\sim$''. For instance, to
