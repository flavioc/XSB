...
programs and modules is fixed.  The syntax to call Prolog predicates is
%%
...
To do this, the Prolog query
%%
\begin{quote}
 ?- bootstrap\_flora.  
\end{quote}
%%
must be executed first. To call \FLORA predicates from the Prolog shell,
...
\end{quote}
%%
To call \FLORA from within a Prolog program, say {\tt test.P}, these {\tt
...
This will insert {\tt foo(a,b,c)} into the default XSB module called {\tt
  usermod}. If {\tt foo/3} is defined in another Prolog module, {\tt bar}, and
