...
{\tt gpp} preprocessor to process its input program. Therefore, any
preprocessing command that is recognized by {\tt gpp} can appear in
a \FLORA program (refer to the XSB manual for more information on
{\tt gpp}). The above mentioned \verb|#include "file_name"| is one
of the preprocessing commands supported by {\tt gpp}.
...
\subsection{Truth Values, Object Values, and Predicate Meta Signature}
