/*****************************************************************************
 *                           dtd.h
 * This file defines constants, macros and enumerations useful in parsing
 *
 ****************************************************************************/
...
/*int		sgml_process_stream(dtd_parser *p, FILE *in, unsigned flags);*/
