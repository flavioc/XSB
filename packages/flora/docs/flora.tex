...
\title{\bf \FLORA's Secrets of Object-Oriented Logic Programming}
...
signs are defined in \FLORA as unary operators; these operators take
precedence over binary operators.
...
%%
\begin{verbatim}
clyde!color.           means: clyde[color *-> X], for some X
obj!!attr.             means: obj[attr *->> Y].
\end{verbatim}
%%
