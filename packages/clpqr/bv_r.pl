...
:- module(bv_r,
	[
	    ...
	    dump_var/6, bv_r_dump_var/6,
	    dump_nz/5, bv_r_dump_nz/5,
	    export_binding/1,
	    export_binding/2,
	    get_or_add_class/2,
	    inc_step/2,
...
% we cant substitute V in the linear equation of Y of course. 
...
/* TLS: helps get around XSB module limitations */
bv_r_dump_nz(Q,W,E,R,T):- dump_nz(Q,W,E,R,T).
