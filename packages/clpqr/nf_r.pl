/*  
    ...
    This software is part of Leslie De Konincks master thesis, supervised
...
% nf_mul_k(A,B,C)
%
% C is the result of the multiplication of each element of A (of the form v(_,_)) with scalar B (which shouldnt be 0) 
nf_mul_k([],_,[]).
